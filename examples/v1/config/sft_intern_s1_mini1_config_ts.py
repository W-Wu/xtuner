...
from xtuner.v1.model import InternS1MiniTSConfig
...
meta_data_path = "/mnt/shared-storage-user/brainllm-share/wuwen/times_v2/scp_xtuner/ts_test.json"
work_dir = os.environ['WORK_DIR']
tokenizer_cache_dir = os.environ['TOKENIZER_CACHE_DIR']
global_batch_size = int(os.environ.get('GLOBAL_BATCH_SIZE', 8))

# model_path = "/mnt/shared-storage-user/llmrazor-share/model/intern-s1-mini"
model_path = "/mnt/shared-storage-user/brainllm-share/wuwen/internts/internts-v2_1/interns1mini_ts_v3_freezellm_4task_merged_sysprompts1_20251201172329_hf-4740"
...
# model config
model_cfg = InternS1MiniTSConfig()
